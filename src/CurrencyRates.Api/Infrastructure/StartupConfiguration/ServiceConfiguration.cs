...
using CurrencyRates.Api.Filters;
using CurrencyRates.Api.Infrastructure.Options;
using CurrencyRates.Application;
using CurrencyRates.Infrastructure;
using CurrencyRates.Persistence;
using CurrencyRates.Persistence.Database;

namespace CurrencyRates.Api.Infrastructure.StartupConfiguration;
